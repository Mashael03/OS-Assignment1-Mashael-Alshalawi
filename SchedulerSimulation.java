...
class Process implements Runnable {
    ...
    private int priority; // 1 Feature: Added priority to each process
    // 3 Feature: Waiting time tracking
...
public class SchedulerSimulation {
    ...
    static int contextSwitches = 0; // 2 Feature: Context switch counter
